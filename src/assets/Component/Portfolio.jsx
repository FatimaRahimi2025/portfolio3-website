...
import instalNode from "../portfolio/installNode.jpg";
import Navbar from "../portfolio/navbar.jpg";
import reactParalax from "../portfolio/reactParallax.jpg";
    ...
    return(
        <div name="portfolio" className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen ">
            <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
                ...
                <div className="gird sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 ">
